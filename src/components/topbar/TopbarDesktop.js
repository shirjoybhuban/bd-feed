  ...
  return (
    <div className="flex justify-between items-center gap-4">
      ...
      <div className="flex items-center md:gap-5 lg:gap-12">
        ...
        <p className="font-medium text-sm cursor-pointer hover:text-primary-900">My Feed</p>
        <p className="font-medium text-sm cursor-pointer hover:text-primary-900">Tending Topic</p>
      </div>
      {/* Navbar Right Side */}
